...
import ru.i_novus.integration.registry.api.rest.PrepareRequestRestService;
...
@Controller
public class RestServiceInfoRest implements PrepareRequestRestService {
    ...
    public RestServiceInfoRest(ParticipantRepository participantRepository,
