...
INSERT INTO sec.user(id,username,name,email,is_active,password) VALUES (1,'admin','Администратор','aadmin@test.adm',TRUE,'$2a$10$.aw1JNVIJRFl/BUMX2mDO.O7nRxzsxUK3gxbvLr.Lfgzd6xmvYnfq');

INSERT INTO sec.account(id, user_id, name, is_active) VALUES (1, 1, 'Аккаунт администратора', true);

INSERT INTO sec.account_role (account_id,role_id) VALUES (1,(SELECT id FROM sec.role WHERE code='access.admin'));